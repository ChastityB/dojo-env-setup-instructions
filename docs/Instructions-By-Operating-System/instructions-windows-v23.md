...
- One non-default option that you may want to select is to "Enable symbolic links" in the screenshot below.
  - This option will be helpful if you ever need to access data stored on a network drive. This will _not_ be required for the program.
...
If you receive an error message when activating your dojo-env, please see "Step 2.3.5) _(Only if needed)_ Troubleshoot Conda Activate Errors."
...
- **If the file path does _not_ start with** "/c/Users/":
