...
#### Step 1.3.B.2) Remove the old dojo-env kernel from Jupyter _(Optional)_

_Note: if you are installing the new dojo-env you do not need to perform this step, as the new dojo-env will be installed in the same place as the old one._
...
- **Solution B): If you do _not_ see `dojo-env` in the list**
